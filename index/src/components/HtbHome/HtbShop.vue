<template>
    <div class="h-home-shop">
        <ul class="h-shop-main">
            <li>
                <div class="h-shop-img">
                    <img src="/static/img/htbimg/t-1_07.png" alt="">
                </div>
                <div class="h-shop-tit">
                    ...
                    <section>
                        <div class="h-home-shop-money">
                            <span>1999</span>
                        </div>
                        <div class="h-home-shop-comment">
                            <span>2999</span>
                        </div>
            ...
            <li>
                <div class="h-shop-img">
                    <img src="/static/img/htbimg/xs-2_07.png" alt="">
                </div>
                <div class="h-shop-tit">
                    <div>
                        <p>北欧式木桌</p>
                        <p>EUROPEAN PRINCESS BED</p>
                    </div>
                    <section>
                        <div class="h-home-shop-money">
                            <span>1999</span>
...
<style scoped>
    ...
    .h-shop-tit>div{
        border-left: 3px solid #fbae13;
        padding-left: 0.06rem;
        display: flex;
        flex-wrap: wrap;
    }
    .h-shop-tit>div>p:last-child{
        color: #6b6b6b;
        font-size: 0.1rem;
        font-weight: 500;
    ...
    .h-home-shop-det>ul>li:nth-child(2),.h-home-shop-det>ul>li:nth-child(3){
        margin-left: -0.05rem;
    }
    .h-home-shop-det>ul>li:nth-child(4){
        width:0.13rem;
        height: 0.13rem;
        color: #fff;
        font-size: 0.1rem;
