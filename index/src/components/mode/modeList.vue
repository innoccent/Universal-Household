    ...
    <div class="modelist">
        <div class="deng">
            <div class="main-title">
                ...
                <div class="main-title-right">
                    <router-link :to="{name:'modedetails',query:{cateid:customize.length ? customize[0].id:''}}">
                        <div class="jiantou-right">
                            <img src="/static/img/nxl_jiaontou.png" alt="">
                        </div>
                    </router-link>
                </div>
            </div>
        ...
        <div class="jiashi">
            <div class="main-title">
                ...
                <div class="main-title-right">
                    <router-link :to="{name:'modedetails',query:{cateid:customize.length ? customize[1].id:''}}">
                        <div class="jiantou-right">
                            <img src="/static/img/nxl_jiaontou.png" alt="">
                        </div>
                    </router-link>
        ...
        <div class="sofa">
            <div class="main-title">
                ...
                <div class="main-title-right">
                    <router-link :to="{name:'modedetails',query:{cateid:customize.length ? customize[2].id:''}}">
                        <div class="jiantou-right">
                            <img src="/static/img/nxl_jiaontou.png" alt="">
                        </div>
                    </router-link>
        ...
        <div class="chuang">
            <div class="main-title">
                ...
                <div class="main-title-right">
                    <router-link :to="{name:'modedetails',query:{cateid:customize.length ? customize[3].id:''}}">
                        <div class="jiantou-right">
                            <img src="/static/img/nxl_jiaontou.png" alt="">
                        </div>
                    </router-link>
        ...
        <div class="table">
            <div class="main-title">
                ...
                <div class="main-title-right">
                    <router-link :to="{name:'modedetails',query:{cateid:customize.length ? customize[4].id:''}}">
                        <div class="jiantou-right">
                            <img src="/static/img/nxl_jiaontou.png" alt="">
                        </div>
                    </router-link>
...
<script>
    export default {
        ...
        methods: {
            filter(cid) {
                return this.goods.filter(v => v.cid == cid && v.is_pos == 1)
            }
        },
        mounted() {
